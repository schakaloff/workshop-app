...
**Interfaces:**
- Produces: SFTP endpoint reachable at `sftp://100.92.61.4:1337` with user `workshopfiles`, password `W0rksh0pFiles2026!`, chroot `/var/workshop-files`, uploads dir `/var/workshop-files/uploads`
...
# Enter password: W0rksh0pFiles2026!
...
- Produces:
  ...
  - `SftpConfig.PASSWORD` = `"W0rksh0pFiles2026!"`
...
public class SftpConfig {
    ...
    public static final String PASSWORD = "W0rksh0pFiles2026!";
