...
public class PrintEstimateController {
    ...
    @FXML private Text      totalPSTTXT;
    @FXML private Text      totalGSTTXT;
    ...
    private static final double PAGE_CUTOFF  = 735.0;
    ...
    public void initData(WorkOrder wo,
        ...
        // — this used to zero parts out under warranty, so a warranty estimate's
    ...
    private void buildPartsRowsWithOverflow(ObservableList<PartTable> partsData,
        ...
        if (!overflowRows.isEmpty()) {
            ...
            totalPSTTXT.setVisible(false);
            totalGSTTXT.setVisible(false);
